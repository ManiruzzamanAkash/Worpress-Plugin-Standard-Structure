...
class Menu
{
    ...
    public function admin_menu()
    {
        ...
        $hook = add_menu_page(__('weDevs Academy', 'wedevs-academy'), __('Academy', 'wedevs-academy'), $capability, $parent_slug, [$this->addressBook, 'plugin_page'], 'dashicons-admin-home');
