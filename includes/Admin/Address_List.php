...
class Address_List extends \WP_List_Table {
    ...
    public function column_name( $item ) {
        ...
        // Previous way to delete server side
        ...
        $actions['delete'] = sprintf( '<a href="%s" class="submitdelete" data-id="%s" title="%s">%s</a>', $item->id, $item->id, __( 'Delete', 'wedevs-academy' ), __( 'Delete', 'wedevs-academy' ) );
